...
import net.dwade.core.exception.ArgumentException;
...
public class Assert {
	 ...
	 * <p>Call {@link #isTrue} if you wish to throw an {@code ArgumentException}
	...
	/**
	 * Assert a boolean expression, throwing an {@code ArgumentException}
	 * if the expression evaluates to {@code false}.
	...
	public static void notNull(Object object) {
		notNull(object, "this argument must not be null");
	}
	...
	public static void hasLength(String text) {
		hasLength(text,
				"this argument must not be null or empty");
	}
	 ...
	 * @throws ArgumentException if the text does not contain valid text content
	 */
	...
	public static void hasText(String text) {
		hasText(text, "this argument must not be null, empty, or blank");
	}
	...
	public static void notEmpty(Object[] array) {
		notEmpty(array, "this array must not be empty");
	}
	...
	public static void notEmpty(Collection<?> collection) {
		notEmpty(collection,
				"this collection must not be empty");
	}
	...
	/**
	 * 判断参数是否包含在seqs中的任何一个，否则抛出ArgumentException
	 */
	public static void containsAny( CharSequence text, CharSequence... seqs ) {
		if ( !StringUtils.containsAny( text, seqs ) ) {
